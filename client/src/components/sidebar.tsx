...
export function Sidebar({ isMobileOpen, onCloseMobile }: SidebarProps) {
  ...
  const links = [
    ...
    { id: "time-blocks", href: "/time-blocks", label: "Time Blocks", icon: <CalendarRange className="w-5 h-5 mr-3" /> },
    { id: "daily-goals", href: "/daily-goals", label: "Daily Goals", icon: <CheckSquare className="w-5 h-5 mr-3" /> },
